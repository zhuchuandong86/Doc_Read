...
- **战略解码**：基于管理层的表述、资源投入走向或高优考核指标，提炼当前企业最核心的 3-5 个战略重心，并描述清楚。
- **第二曲线**：深度分析新业务的战略方向和结果。
- **铁律**：**拒绝毫无灵魂的数字罗列，必须拔高到“商业模式与护城河”的高度进行战略洞察！要用数据验证战略，而不是重复口号。**如果原文通篇只有传统业务，则直接表达未提及新业务”，**绝不允许硬编、臆想任何新业务。**
